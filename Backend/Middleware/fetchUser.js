...
const JWT_SECRET = 'Onetwothree';             //declare secret key
...
const fetchuser = (req, res, next) => {
    ...
    //fetch the token from the header 'auth-token' //we will declare the header 'auth-token' while sending the request via client-side
    ...
    try
    {
        ...
        //assign 'data.user' which has 'user.id' to 'req.user' // request(req.user) m load kardo usersId ko // userId ko fetch kya data.user se
