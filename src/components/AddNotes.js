...
const AddNote = (props) => {
  ...
  return <div>
      <div className="container  mt-4" style={{ "width": "80%", "color":"whitesmoke" }}>
                ...
                <form onSubmit={handleClick}>
                    ...
                    <button disabled={note.title.length<2 || note.description.length<5} type="submit" onClick={handleClick} style={{"color" : "white"}} className="btn btn-secondary">Add Note</button>
                </form>
            </div>
  </div>;
};
