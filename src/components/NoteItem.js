    ...
    <div className="col-md-3">
        <div className="card my-2">
            <div className="card-body">
                ...
                {/* we call the delete function here and pass the note id of that particular note clicked  && we are getting the note id as each and every element(object) represents a card which has its id, title, description, tag*/}
