                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <form>
                                    <div className="mb-3">
                                        <label htmlFor="etitle" className="form-label" style={{"color" : "black", "fontFamily": "bold", "fontWeight":"bolder"}}>Edit Title</label>
                                    ...
                                    <div className="mb-3">
                                        <label htmlFor="edescription" className="form-label"  style={{"color" : "black", "fontFamily": "bold", "fontWeight":"bolder"}}>Edit Description</label>
                                    ...
                                    <div className="mb-3">
                                        <label htmlFor="etag" className="form-label"  style={{"color" : "black", "fontFamily": "bold", "fontWeight":"bolder"}}>Edit Tags</label>
